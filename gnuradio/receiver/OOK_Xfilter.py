...
class OOK_Xfilter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._numbers_range = Range(1, 2000, 10, 2000, 200)
        ...
        self.digital_correlate_access_code_tag_xx_0 = digital.correlate_access_code_tag_bb('1010101011', 0, 'preamble')
        ...
        self.connect((self.blocks_float_to_char_1, 0), (self.digital_correlate_access_code_tag_xx_0, 0))
        self.connect((self.blocks_keep_one_in_n_0, 0), (self.blocks_float_to_char_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_lowpass_filter(firdes.low_pass(1, self.samp_rate, self.cutoff_freq, self.transition_width, firdes.WIN_HAMMING, 6.76))
        self.qtgui_time_sink_x_0.set_samp_rate(self.samp_rate/self.numbers)
        self.qtgui_time_sink_x_0_0.set_samp_rate(self.samp_rate/self.numbers)
